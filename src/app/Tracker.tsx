...
export function Tracker({ mode, audience }: { mode: TrackerMode; audience: AudienceChoice }) {
    ...
    <QueryClientProvider client={tracker.queryClient}>
      <TrackerEnvironmentContext.Provider value={tracker.environment}>
        <AppShell
          ...
          toggle={<SegmentedLinks label="All, followers, or connections" links={tracker.audienceLinks} />}
