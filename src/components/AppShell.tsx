...
export function AppShell({ title, subtitle, toggle, logoSrc, navItems, banner, headerAction, navAction, children }: AppShellProps) {
  return (
    <div className="min-h-svh text-foreground">
      <header className="border-b bg-card/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-3 pt-5 pb-3 sm:pt-7 lg:flex-nowrap">
            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-muted-foreground sm:mt-1 sm:text-sm lg:whitespace-nowrap">{subtitle}</p>
              </div>
            </div>
